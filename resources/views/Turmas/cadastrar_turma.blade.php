<html lang="pt-br">
    ...
    <body>
        ...
        <div class="container-fluid">
            {!! Form::open(['route' => 'turmas.store','class' => 'form-horizontal','name' => 'form1'])!!}         
            <input type="hidden" name="STATUS" value="OCUPADA">
            ...
            <div class="row">
                <div class="form-group col-sm-12">                   
                    ...
                    <div class="col-sm-2">
                        <input type="date" class="form-control" name="ANO" value="" required="">
                    </div>
