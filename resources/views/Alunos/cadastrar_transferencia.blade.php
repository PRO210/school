                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <th colspan="3" style="height:48px;">                                    
                            Não Existe Pedido(s) de Transferência(s) para Esse Aluno(a)!
                        </th>
                        @else
                        <th colspan="3" style="height:48px;">                                    
                            Existe Pedido(s) de Transferência(s) para Esse Aluno(a)!<br>Por vafor Pesquise Antes de Pedir Outra.
                        </th>
                        @endif
                    </tr>
                    <tr>
