...
<div class="container-fluid">
    ...
    <h1>Cargos <a href="{{ route('roles.create') }}" class="btn btn-success">ADD</a></h1>
@stop
<style>
    .preto{
        color: black;
                    ...
                    @foreach ($roles as $role)
                        <tr>
                            ...
                            <td style="width=10px;">
                                ...
                                <a href="{{ route('roles.permissions', $role->id) }}" class="btn btn-warning"><i class="fas fa-lock preto"></i></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
